...
const componentHandleConfigs: Record<LogicComponentType, HandleProperties[]> = {
    ...
    regfile: [
        ...
        { side: Position.Bottom, distance: "40%", handle: "source", id: "sr2mux" },
        { side: Position.Bottom, distance: "60%", handle: "source", id: "alu" }
    ],
    memory: [
        { side: Position.Right, distance: "25%", handle: "target", id: "mar-in" },
        { side: Position.Left, distance: "50%", handle: "target", id: "mdr-in" },
    ...
    fsm: [
        { side: Position.Left, distance: "20%", handle: "target", id: "ir-15-9" },
        { side: Position.Left, distance: "40%", handle: "target", id: "ready" },
        { side: Position.Left, distance: "60%", handle: "target", id: "nzp" },
